...
public class GameState {
    ...
    public void gameState1() {
        ...
        circleObjects.add(new CircleObject(700, 0, 15, coordinateTransposer, textureDrawer, "star2"));
    ...
    public void gameState2() {
        ...
        circleObjects.add(new CircleObject(0, 0, 5, coordinateTransposer, textureDrawer, "earth"));
